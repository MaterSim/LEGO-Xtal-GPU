...
#init_file = '../Fig2/output/initial/15853-cF256-aaa-init.cif'
init_file = 'diamond_subgroup.cif'
t1 = time.time()
xtal = pyxtal()
...
xtal_opt, sim1, xs = bu.optimize_xtal(xtal, minimizers=[('Nelder-Mead', 600), ('L-BFGS-B', 400), ('L-BFGS-B', 400)])
t2 = time.time()
